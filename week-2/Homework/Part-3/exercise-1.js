...
function getOwnerFullName(house) {return house.currentOwner.firstName + " " + house.currentOwner.lastName};

// returns an array of the owners' email addresses of the two houses
function getEmailAddresses(house1, house2) {return [house1.currentOwner.email, house2.currentOwner.email]};

// returns the address for the cheapest house out of the two
function getCheapestAddress(house1, house2) {if (house1.price > house2.price) {return house2.address} else if (house1.price < house2.price){return house1.address}}
